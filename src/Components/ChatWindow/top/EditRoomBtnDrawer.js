  ...
  return (
    <div>
      ...
      <Whisper
        ...
        speaker={
          <Tooltip>
            You're admin and has right to change name and description of this
            group
          </Tooltip>
        }
      >
        <Button {...attr} size="sm" color="red" onClick={open}>
      ...
      <Drawer show={isOpen} onHide={close} placement="right">
        <Drawer.Header>
          <Drawer.Title className="text-white">Edit Room</Drawer.Title>
        </Drawer.Header>
        <Drawer.Body>
          <EditableInput
            initialValue={name}
